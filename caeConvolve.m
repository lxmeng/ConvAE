function convolvedFeatures = caeConvolve(filterDims, numFilters, images, W, b)
...
imageDims = [size(images, 1), size(images, 2)];
convDims = imageDims - filterDims + 1;% full
convolvedFeatures = zeros(convDims(1), convDims(2), numImages, numFilters); 
...
%for imageNum = 1:numImages 
  for filterNum = 1:numFilters
    ...
    %%% YOUR CODE HERE %%%
    convolvedImage = convn(images, feature, 'valid');
    % Add the bias unit
