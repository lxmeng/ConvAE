function [cost, grad] = caeCost(theta, images, images_Nonoise, filterDims, numFilters, poolDims, lambda, poolIndex, poolMethod, convMethod, getCost)
...
ReconsDiff = (images_Constr - images_Nonoise) ;%.* repmat(edgemask, [1 1 1 numImages]);             
...
for imageNum = 1:numImages 
  for featureNum = 1:numFilters      
      pooldelta = squeeze(delta_pool(:,:,:, featureNum, imageNum));
